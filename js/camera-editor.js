...
const CameraEditor = (() => {
  ...
  const CONTROLS = {
    angle: {
      ...
      type: 'select',
      options: [
        { value: 'worms-eye', label: '地面から', icon: '🐛', prompt: "extreme low-angle shot, worm's eye view from ground level. The camera is on the ground. The horizon line is at the very bottom of the frame. Subjects tower above the camera. The sky fills most of the background. The ground/floor is visible in the immediate foreground. It is natural for the sky to dominate the frame and for some background elements to be partially out of view or obscured — do not force all objects to remain fully visible" },
        ...
        { value: 'birds-eye', label: '真上', icon: '🦅', prompt: "steep high-angle shot looking down at approximately 70 degrees from above. The camera is positioned high above and slightly in front of the subject. The ground/floor dominates the frame. Subjects are seen mostly from above — the tops of heads and shoulders are prominent, but faces may be partially visible at an angle. The horizon line is near the very top of the frame or not visible. The entire scene is viewed from this steep overhead angle. Maintain the same body orientation and facing direction as the original image" },
      ],
    },
    shotType: {
      label: '距離（ショットタイプ）',
