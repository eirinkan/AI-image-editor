  ...
  const CONTROLS = {
    angle: {
      ...
      options: [
        ...
        { value: 'birds-eye', label: '真上', icon: '🦅', prompt: "steep high-angle shot looking down at approximately 80 degrees from above. The camera is positioned almost directly above the subject with a slight forward offset. The ground/floor dominates the frame. Subjects are seen almost entirely from above — the tops of heads and shoulders are prominent, faces are barely visible or not visible. The horizon line is not visible. The entire scene is viewed from this near-overhead angle. Maintain the same body orientation and facing direction as the original image" },
      ],
    },
    shotType: {
      label: '距離（ショットタイプ）',
