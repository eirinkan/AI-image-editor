  ...
  const CONTROLS = {
    angle: {
      ...
      options: [
        ...
        { value: 'birds-eye', label: '真上', icon: '🦅', prompt: "bird's eye view, directly overhead top-down perspective looking straight down at 90 degrees. The camera is positioned directly above the main subject. The viewer sees the tops of heads, tops of shoulders, and the ground/floor below. No horizon line is visible. Faces are NOT visible — only hair and the top of the head. The entire scene (both subjects and background) is viewed from directly above. From this overhead angle, 'facing direction' means the body's orientation on the ground plane — the head-to-feet axis must point the same compass direction as the original" },
      ],
    },
    shotType: {
      label: '距離（ショットタイプ）',
